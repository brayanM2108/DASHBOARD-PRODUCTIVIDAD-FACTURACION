...
CSS_ADMIN_REPORT_FILTERS = """
<style>
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] {{
    background: {WHITE} !important;
    border: 0.5px solid {BORDER} !important;
    border-left: 3px solid {BLUE} !important;
    border-radius: 10px !important;
...
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] > div {{
    align-items: flex-end !important;
}}
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stDateInput"] > label,
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stDateInput"] p,
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stMultiSelect"] > label,
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stMultiSelect"] p {{
    font-size: 11px !important;
    color: {MUTED} !important;
    font-weight: 500 !important;
    margin-bottom: 4px !important;
...
.st-key-admin_report_filters [data-testid="stDateInput"]:focus-within,
.st-key-admin_report_filters [data-testid="stDateInput"] *:focus-within:not(input),
.st-key-admin_report_filters [data-testid="stDateInput"]:focus-visible,
.st-key-admin_report_filters [data-testid="stDateInput"] *:focus-visible:not(input),
.st-key-admin_report_filters [data-testid="stMultiSelect"]:focus-within,
.st-key-admin_report_filters [data-testid="stMultiSelect"] *:focus-within,
.st-key-admin_report_filters [data-testid="stMultiSelect"]:focus-visible,
.st-key-admin_report_filters [data-testid="stMultiSelect"] *:focus-visible,
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stDateInput"]:focus-within,
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stDateInput"] *:focus-within:not(input),
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stDateInput"]:focus-visible,
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stDateInput"] *:focus-visible:not(input),
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stMultiSelect"]:focus-within,
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stMultiSelect"] *:focus-within,
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stMultiSelect"]:focus-visible,
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stMultiSelect"] *:focus-visible {{
    box-shadow: none !important;
    outline: none !important;
    border-color: inherit !important;
}}
.st-key-admin_report_filters [data-testid="stDateInput"] {{
    margin-bottom: 0 !important;
}}
.st-key-admin_report_filters [data-testid="stDateInput"] .st-df {{
    padding-right: 0 !important;
}}
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stDateInput"] input {{
    background: {WHITE} !important;
    border: 0.5px solid {BORDER} !important;
    border-radius: 8px !important;
    color: {TEXT} !important;
...
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stDateInput"] input:hover {{
    border-color: {BLUE} !important;
}}
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stDateInput"] input:focus {{
    border-color: {BLUE} !important;
    box-shadow: 0 0 0 3px rgba(21,101,192,.1) !important;
    outline: none !important;
}}
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stMultiSelect"] {{
    margin-bottom: 0 !important;
}}
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-baseweb="select"],
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-baseweb="select"] > div {{
    background: {WHITE} !important;
    border: 0.5px solid {BORDER} !important;
    border-radius: 8px !important;
    min-height: 38px !important;
...
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-baseweb="select"]:hover,
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-baseweb="select"] > div:hover {{
    border-color: {BLUE} !important;
}}
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-baseweb="select"]:focus-within,
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-baseweb="select"] > div:focus-within {{
    border-color: {BLUE} !important;
    box-shadow: 0 0 0 3px rgba(21,101,192,.1) !important;
    outline: none !important;
}}
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-baseweb="select"] span {{
    color: {TEXT} !important;
    font-size: 13px !important;
}}
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-baseweb="select"] svg {{
    fill: {MUTED} !important;
}}
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-baseweb="select"] input {{
    color: {TEXT} !important;
    font-size: 13px !important;
}}
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stMultiSelect"] [data-baseweb="tag"] {{
    background: {BLUE_LIGHT} !important;
    border-radius: 6px !important;
    font-size: 12px !important;
    font-weight: 500 !important;
...
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stMultiSelect"] [data-baseweb="tag"] svg {{
    fill: {MUTED} !important;
    cursor: pointer !important;
}}
.st-key-admin_report_filters [data-testid="stHorizontalBlock"] [data-testid="stMultiSelect"] [data-baseweb="tag"]:hover {{
    background: {SKY_LIGHT} !important;
}}
.st-key-admin_report_filters [data-baseweb="calendar"],
.st-key-admin_report_filters [data-baseweb="calendar"] [data-baseweb="calendar-header"] {{
    background: {NAVY2} !important;
    border: 0.5px solid rgba(255,255,255,.1) !important;
    border-radius: 10px !important;
    box-shadow: 0 8px 24px rgba(0,0,0,.3) !important;
...
.st-key-admin_report_filters [data-baseweb="calendar"] button:hover {{
    background: rgba(249,120,56,.15) !important;
}}
.st-key-admin_report_filters [data-baseweb="calendar"] button[aria-selected="true"] {{
    background: {ORANGE} !important;
    color: {WHITE} !important;
    border-radius: 8px !important;
}}
