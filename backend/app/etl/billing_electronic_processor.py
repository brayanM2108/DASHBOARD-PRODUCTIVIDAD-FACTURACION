"""
ETL - Electronic Billing
========================
DataFrame transformations, filters and productivity calculations for
electronic billing.
"""
...
def get_billing_with_user(billing_df, electronic_billing_df, billers_df=None):
    ...
    prepared_df = prepare_electronic_billing_df(electronic_billing_df)
    if prepared_df is None or prepared_df.empty:
